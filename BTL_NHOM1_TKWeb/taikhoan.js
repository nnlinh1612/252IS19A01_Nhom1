if (!localStorage.getItem("cinema_users")) {
  localStorage.setItem(
    ...
    JSON.stringify([
      ...
      { id: 2, name: "Nguyễn Nhật Linh", email: "nlinh@gmail.com", phone: "0987654321", password: "123456" },
      { id: 3, name: "Trịnh Thị Nhâm", email: "nhamtrinh@gmail.com", phone: "0111222333", password: "123456" },
...
if (!localStorage.getItem("cinema_tickets")) {
  localStorage.setItem("cinema_tickets", JSON.stringify([{ id: "VE001234", email: "admin@plant.com", movie: "Mortal Kombat", date: "25/05/2026", time: "19:30", seats: ["A1", "A2"], combo: "Combo Bắp Nước", total: 210000 }]));
}
